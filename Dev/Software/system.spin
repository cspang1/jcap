CON
    ...
    NUM_TILE_PALETTES = $34+1                       ' Number of tile palettes
    NUM_SPRITE_PALETTES = 0                         ' Number of sprite palettes
    SPR_SZ_S = 8                                    ' Number of pixels wide/tall for small sprites
    SPR_SZ_L = 16                                   ' Number of pixels wide/tall for large sprites
    NUM_PARALLAX_REGS = 57                          ' Max number of parallaxing regions on screen
